...
| `xf-library` | "what library should I use for…", "is there an XF library for caching/Postgres/…", "build or reuse?" | Reuse advisor: frames the need as a capability + L×T cell, resolves the best-fit library **live** in your ecosystem (npm/NuGet/PyPI/Maven), or says hand-write it. Advice only. |
