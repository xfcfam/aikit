<!-- Thanks for contributing to the XF AI tooling. -->

## Summary

<!-- What .md instruction / plugin file you added or changed and why. -->

## Type of change

- [ ] New instruction file
- [ ] Update to existing instruction
- [ ] Claude plugin manifest change
- [ ] Tooling / CI / docs
